...
import (
	...
	http "net/http"
	strings "strings"
	v1 "github.com/fraser-isbester/federated-gql/gen/go/order/v1"
)
...
// NewOrderServiceHandler builds an HTTP handler from the service implementation. It returns the path
...
func NewOrderServiceHandler(svc OrderServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle(OrderServiceGetOrderProcedure, connect_go.NewUnaryHandler(
		OrderServiceGetOrderProcedure,
		svc.GetOrder,
		opts...,
	))
	return "/order.v1.OrderService/", mux
}
...
func (UnimplementedOrderServiceHandler) GetOrder(context.Context, *connect_go.Request[v1.GetOrderRequest]) (*connect_go.Response[v1.GetOrderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("order.v1.OrderService.GetOrder is not implemented"))
}